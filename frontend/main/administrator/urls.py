...
urlpatterns = [
    ...
    path('about_admin/', views.about, name='about_admin'),
    path('history/', views.history, name='history'),
    path('data_selected/<id>', views.data_selected, name='data_selected'),
    ...
    path('echarts_types/', views.echarts_types, name='echarts_types'),
]
