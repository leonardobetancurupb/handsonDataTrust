...
const loadDatasets = async () => {
    ...
    try {
        ...
        // Fetch holders
        const holdersResponse = await fetch(`http://backend:8000/api/holders/`);
        ...
        // Fetch dataset
        const datasetResponse = await fetch(`http://backend:8000/api/data/${getIdFromUrl()}`);
        ...
        const policyResponse = await fetch(`http://backend:8000/api/policy/${dataset.idPolicy}/`);
        const policy = await policyResponse.json();
        const schemaResponse = await fetch(`http://backend:8000/api/schema/${dataset.idSchema}/`);
        const schema = await schemaResponse.json();
        const categoryResponse = await fetch(`http://backend:8000/api/category/${dataset.idSchema}/`);
        ...
        const cardHtml = `
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex w-25 justify-content-end h-75">
                    ...
                    <div class="d-block mr-3">
                        <a href="#" class="delete-dataset text-success" data-url="http://backend:8000/api/data/${dataset.id}/">
