...
const loadDatasets = async () => {
    ...
    try {
        ...
        const getIdHolderResponse = await fetch(`http://127.0.0.1:8000/api/holders/`, requestOptions);
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <a href="#" data-url="http://127.0.0.1:8000/data/${dataset.id}/" class="mr-1 delete-dataset">
